...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mGZOSPSettingsObserver.observe();
        mGZOSPSettingsObserver.update();
    ...
    private GZOSPSettingsObserver mGZOSPSettingsObserver = new GZOSPSettingsObserver(mHandler);

    private class GZOSPSettingsObserver extends ContentObserver {
        GZOSPSettingsObserver(Handler handler) {
            super(handler);
        }
